...
from xDL.shapefuncs.transformer_encoder import MaskedFTTransformerEncoder
...
class MaskedTransformer(BaseModel):
    def __init__(
        self,
        data,
        y,
        ...
        assert masking in [
            "random",
            "random_all",
        ], "masking must be a valid option of either 'random' or 'random_all'"
        ...
        if encoder:
            ...
            self.encoder = MaskedFTTransformerEncoder(
